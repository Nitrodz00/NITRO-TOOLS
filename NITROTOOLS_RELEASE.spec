...
# Optional: set PYINSTALLER_EXE_NAME (e.g. NITROTOOLS_PUBG_MOBILE_v2.1.5) for CI/local builds
import os
from PyInstaller.utils.hooks import collect_all, copy_metadata

_exe_basename = os.environ.get("PYINSTALLER_EXE_NAME", "NITROTOOLS_PUBG_MOBILE_v2.5.0")
