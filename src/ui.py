...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.appbackground.setStyleSheet(u"border-image: url(" + resource_path(r"assets\\nitro_bg.png").replace("\\\\", "/") + ");")
        ...
        self.gfx_page_background.setStyleSheet(u"border-image: url(" + resource_path(r"assets\\nitro_bg.png").replace("\\\\", "/") + ");")
        ...
        self.graphics_label.setGeometry(QRect(11, 5, 200, 40))
        ...
        self.super_smooth_graphics_btn = QPushButton(self.layoutWidget)
        self.super_smooth_graphics_btn.setObjectName(u"super_smooth_graphics_btn")
        sizePolicy.setHeightForWidth(self.super_smooth_graphics_btn.sizePolicy().hasHeightForWidth())
        self.super_smooth_graphics_btn.setSizePolicy(sizePolicy)
        self.super_smooth_graphics_btn.setMinimumSize(QSize(141, 41))
        self.super_smooth_graphics_btn.setMaximumSize(QSize(141, 41))
        self.super_smooth_graphics_btn.setFont(font3)
        self.super_smooth_graphics_btn.setStyleSheet(u"")
        self.super_smooth_graphics_btn.setCheckable(True)
        self.super_smooth_graphics_btn.setFlat(True)
        self.GraphicsLayout.addWidget(self.super_smooth_graphics_btn)
        ...
        self.fps_label.setGeometry(QRect(10, 5, 200, 40))
        ...
        self.ShadowFrame.setMinimumSize(QSize(1, 120))
        ...
        self.shadow_label.setGeometry(QRect(10, 5, 200, 40))
        ...
        self.layoutWidget_2.setGeometry(QRect(10, 55, 300, 50))
        ...
        self.other_page_background.setStyleSheet(u"border-image: url(" + resource_path(r"assets\\nitro_bg.png").replace("\\\\", "/") + ");")
        ...
        self.ipad_code.setStyleSheet(u"border-image: none;\n"
                                     "                                text-align: center;\n"
                                     "                                color: #969696;\n"
                                     "\n"
                                     "                            ")
        ...
        self.label_8.setStyleSheet(u"border-image: url(" + resource_path(r"assets\\nitro_bg.png").replace("\\\\", "/") + ");")
    ...
    def retranslateUi(self, MainWindow):
            MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"NITROTOOLS PUBG MOBILE", None))
            ...
            self.super_smooth_graphics_btn.setText(QCoreApplication.translate("MainWindow", u"Super Smooth", None))
            ...
            self.about_label_text.setText(QCoreApplication.translate("MainWindow",
                                                                     u"<h2>Optimize Your PUBG Mobile Experience with NITROTOOLS PUBG MOBILE</h2>\n"
                                                                     "\n"
                                                                     "                                <h3>Features:</h3>\n"
                                                                     "                                <ul>\n"
                                                                     ...
                                                                     "                                </center>\n"
                                                                     "                            ", None))
            self.appname_label.setText(QCoreApplication.translate("MainWindow", u"NITROTOOLS PUBG MOBILE v2.4.0", None))
