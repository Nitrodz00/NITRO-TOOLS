...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.appbackground.setStyleSheet(u"border-image: url(" + resource_path("assets/nitro_bg.png").replace("\\", "/") + ");")
        ...
        self.gfx_page_background.setStyleSheet(u"border-image: url(" + resource_path("assets/nitro_bg.png").replace("\\", "/") + ");")
        ...
        self.other_page_background.setStyleSheet(u"border-image: url(" + resource_path("assets/nitro_bg.png").replace("\\", "/") + ");")
        ...
        self.label_8.setStyleSheet(u"border-image: url(" + resource_path("assets/nitro_bg.png").replace("\\", "/") + ");")
