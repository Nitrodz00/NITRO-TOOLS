...
class Settings:
    def __init__(self):
        self.settings = QSettings("NITRO Apps", "NITROTOOLS PUBG MOBILE")
...
class Optimizer(Registry):
    ...
    def set_ultimate_performance_power_plan(self):
        ...
        try:
            ...
            # Activate it
            res = subprocess.run(["powercfg", "/setactive", "e9a42b02-d5df-448d-aa00-03f14749eb61"], 
    ...
    def gameloop_settings(self):
        ...
        self.set_dword("VSyncEnabled", 0) # Force VSYNC off
    ...
    def optimize_for_nvidia(self):
        ...
        try:
            nvidia_profile_path = self.resource_path("assets/nitro.nip")
    ...
    def ipad_layout_settings(self, reset=False):
        ...
        backup_file = os.path.join(keymap_folder, 'TVM_100.xml.nitrobackup')
